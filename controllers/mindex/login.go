...
func (this *LoginController) LoginVerify() {
	this.Data["prevpage"] = "/"
	this.TplName = "mindex/index/login.html"
}
...
func (this *LoginController) SetPass() {
	...
	if flag {
		...
		if len(userVarify) > 0 {
			...
			// 5:定义验证url
			verifyUrl := "127.0.0.1:8080/pass/verifyUrl?verify=" + models.Md5(passwd+"micom") + "&email=" + email
			...
			if err != nil {
				...
				this.Data["redirect"] = "/login/verify"
...
func SendMail(mailTo string, subject string, body string) error {
	...
	mailConn := map[string]string{
		"user": "1975210542@qq.com",
		"pass": "krrxzleukxqmdggi",
		"host": "smtp.qq.com",
		"port": "465",
	}
